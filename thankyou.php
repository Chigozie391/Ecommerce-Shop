<?php 
	...
	$db->query("INSERT INTO transaction
		(cart_id,full_name,email,address,state,phone1,phone2,grand_total,description) VALUES
		('$cart_id','$full_name','$email','$address','$state','$phone1','$phone2','$grand_total','$description') ");
...
?>
	...
	<div class="col-md-6">
		...
		<address>
			...
			<h4><b>Grand Total: </b><span class="bg-success"><?=money($grand_total) ?></span></h4>
		</address>
	</div>
